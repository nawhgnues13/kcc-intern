...
class SalesRegistration(Base):
    ...
    external_contract_no: Mapped[Optional[str]] = mapped_column(String(100), nullable=True, unique=True)
    ...
    car_year: Mapped[Optional[str]] = mapped_column(String(20), nullable=True)
    exterior_color: Mapped[Optional[str]] = mapped_column(String(120), nullable=True)
    interior_color: Mapped[Optional[str]] = mapped_column(String(120), nullable=True)
    sale_price: Mapped[Optional[Decimal]] = mapped_column(Numeric(12, 2), nullable=True)
    invoice_price: Mapped[Optional[Decimal]] = mapped_column(Numeric(12, 2), nullable=True)
